...
class Preference_show(models.Model):
    ...
    min_age = models.FloatField("Min age in years",default= None, null=True, blank=True)
    max_age = models.FloatField("Max age in years",default= None, null=True, blank=True)
